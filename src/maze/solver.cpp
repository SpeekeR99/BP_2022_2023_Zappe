...
bool Solver::is_maze_solvable_dijkstra(std::shared_ptr<Graph> &maze, const std::pair<int, int> &start,
    ...
    return is_maze_solvable_a_star(maze, start, end, HeuristicType::CONSTANT_ZERO); // dijkstra == a* with heuristic of constant 0
}
...
Solver::solve_maze_dijkstra(std::shared_ptr<Graph> &maze, const std::pair<int, int> &start,
    ...
    return solve_maze_a_star(maze, start, end, HeuristicType::CONSTANT_ZERO); // dijkstra == a* with heuristic of constant 0
}
